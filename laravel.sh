...
####################################################
 ...
 <VirtualHost ":80>
     ServerAdmin obigifty6@gmail.com
...
###########################################################
 ...
 #################################################################
  ...
  sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=obigifty/' /var/www/html/laravel/.env

  sudo sed -i 's/DB_USERNAME=laravel/DB_USERNAME=obigifty/' /var/www/html/laravel/.env

  sudo sed -i 's/DB_PASSWORD=laravel/DB_PASSWORD=obigifty22/' /var/www/html/laravel/.env
